...
book_Genre = document.getElementById("book_Genre");

book_year = document.getElementById("book_year");
...
function fetchMusicDetails(mood) {
  ...
  switch (mood) {
    case "Angry":
      ...
      book_title.innerHTML = calm_books[playlist_index].title;
      book_author.innerHTML = calm_books[playlist_index].author;
      book_Genre.innerHTML = calm_books[playlist_index].genre;
      break;
    ...
    case "Happy":
      ...
      book_title.innerHTML = happy_books[playlist_index].title;
      book_author.innerHTML = happy_books[playlist_index].author;
      book_Genre.innerHTML = happy_books[playlist_index].genre;
    ...
    case "Sad":
      ...
      book_title.innerHTML = sad_books[playlist_index].title;
      book_author.innerHTML = sad_books[playlist_index].author;
      book_Genre.innerHTML = sad_books[playlist_index].genre;
      break;
  }
  audio.play();
}
